...
############################################
### DATA INTEGRATION
Fetch upcoming events from **https://pawa-proxy.replit.app/apiplus/events/popular** at load.
                ...
                <div className="container mx-auto p-6 space-y-8 max-w-4xl">
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="space-y-4 max-w-2xl mx-auto">
                            ...
                            <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6 space-y-3">
                                <div className="flex items-center gap-2 mb-2">
                                    <div className="w-6 h-6 bg-gradient-to-br from-green-400 to-green-600 rounded flex items-center justify-center">
                                        <span className="text-white font-bold text-xs">P</span>
                                    </div>
                                    <h3 className="text-lg font-semibold text-gray-900">What is pawabloX?</h3>
                                </div>
                                <p className="text-md text-gray-700 leading-relaxed">
                                    pawabloX is a ready-made design system that looks just like betPawa apps. It includes colors, fonts,
                  ...
                  <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">
                    ✓ Colors & Typography
                                    ...
                                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">✓ Spacing & Layout</span>
                                    <span className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded-full">
                    ✓ Ready Components
                  </span>
                                    <span className="px-2 py-1 bg-orange-100 text-orange-700 text-xs rounded-full">✓ betPawa Style</span>
                                </div>
                            </div>

                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <p className="text-md text-blue-800">
                                    <strong>Choose v0</strong> for frontend-only projects (UI components, landing pages, prototypes)
                                </p>
                                <p className="text-md text-blue-800 mt-1">
                                    <strong>Choose Replit</strong> for full-stack projects that need backend functionality (APIs,
                        ...
                        <TabsContent value="v0" className="space-y-6">
                            ...
                            <Card className="border-green-200 bg-gradient-to-br from-green-50 to-green-100/30">
                                <CardHeader>
                                    ...
                                    <CardDescription>Get started in under 2 minutes with our pre-configured template</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <Button
                                        size="lg"
                                        className="w-full"
                                        onClick={() => window.open("https://v0.dev/community/pawa-blox-ApvLaZA2LHu", "_blank")}
                                    >
                                        <div className="flex items-center gap-2">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-md">Watch how to use pawabloX with v0 in action</CardDescription>
                                </CardHeader>
                                <CardContent>
                                        ...
                                        <CardContent className="pt-6 space-y-4">
                                            <div className="space-y-3">
                                                ...
                                                <p className="text-sm text-muted-foreground">
                                                    If you prefer to use the master prompt manually, copy it below and paste it at the beginning
                                                    of your v0 chats:
                                                </p>
                                                <div className="relative">
                                                    ...
                                                    <div className="bg-gray-50 border rounded-lg p-4 max-h-48 overflow-y-auto">
                                                        <pre className="text-xs text-gray-700 whitespace-pre-wrap font-mono">{masterPrompt}</pre>
                                                    </div>
                                                </div>
                                            </div>
                                        </CardContent>
                        ...
                        <TabsContent value="replit" className="space-y-6">
                            ...
                            <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100/30">
                                <CardHeader>
                                    ...
                                    <CardDescription>Code collaboratively with pawabloX in your browser</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <Button
                                        className="w-full "
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-md">See how to use the system-prompt.txt feature</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="bg-gray-900 rounded-lg p-4 border border-gray-300">
                                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Follow these steps to use pawabloX with Replit Assistant</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    {/* Step 1 */}
                                    <div className="flex gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-muted-foreground text-sm">
                                                Click "Open pawabloX in Replit" above to access our pre-configured project.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <CardContent className="space-y-3">
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Always start with <code className="bg-gray-100 px-1 rounded">@docs/prompt/system-prompt.txt</code> for
                                                best results
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Add betPawa screenshots to your project and reference them in prompts
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Describe exactly what you want: "Create a betting slip with 3 selections"
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="font-semibold text-orange-800">API-Powered Development</h4>
                                </div>
                                <p className="text-sm text-orange-700 mb-3">
                                    pawabloX includes real API endpoints for user authentication, betting, and account management. Perfect
                                ...
                                <div className="flex flex-col sm:flex-row gap-2 mt-4">
                                    <Button
                                        ...
                                        onClick={() => window.open("/pawa-proxy", "_blank")}
                                    >
                                        <div className="flex items-center gap-2">
                                            <ExternalLink className="w-4 h-4 mr-2" />
                                    ...
                                    <Button
                                        ...
                                        size="sm"
                                        className="border-orange-300 text-orange-700 hover:bg-orange-100"
                                        onClick={() => window.open("https://aliengain.github.io/api-portal/pawa-api.html", "_blank")}
                                    >
                                        <div className="flex items-center gap-2">
                                        <ExternalLink className="w-4 h-4 mr-2" />
                                        Complete API Portal
                                ...
                                <div className="grid gap-3">
                                    ...
                                    <div className="bg-gray-50 border rounded-lg p-3">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-sm font-medium text-gray-700">User Authentication</span>
                                        </div>
                                        <code className="text-xs text-gray-600 block bg-white p-2 rounded border">
                                            @api/user.yaml Create a login form that authenticates users with the /api/user/v3/authenticate
                                            endpoint
                                        </code>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 border rounded-lg p-3">
                                        ...
                                        <code className="text-xs text-gray-600 block bg-white p-2 rounded border">
                                            @api/user.yaml Build a signup form using /api/user/v3/signup-and-authenticate with phone
                                            verification
                                        </code>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 border rounded-lg p-3">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-sm font-medium text-gray-700">Password Reset Flow</span>
                                        </div>
                                        <code className="text-xs text-gray-600 block bg-white p-2 rounded border">
                            ...
                            {/* How to Reference APIs */}
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div className="flex items-start gap-3">
                                    <FileText className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                                    <div>
                                        <p className="text-sm font-medium text-blue-800 mb-2">📋 How to Reference API Documentation</p>
                                        <div className="text-xs text-blue-700 space-y-2">
                                            <p>
                                                <strong>In v0:</strong> Upload the API YAML file and reference it in your prompts with
                                                @api/user.yaml
                                            </p>
                                            <p>
                                                <strong>In Replit:</strong> Add the YAML file to your project and use @api/user.yaml in
                                                Assistant prompts
                                            </p>
                                            <p>
                                                <strong>Available APIs:</strong> User authentication, account management, betting, payments, and
                                                more
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                                <div className="flex items-start gap-3">
                                    <FileText className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                                    <div>
                                        <p className="text-sm font-medium text-blue-800 mb-2">📚 API Documentation Resources</p>
                                        <div className="text-xs text-blue-700 space-y-2">
                                            <p>
                                                <strong>API Portal:</strong> For a complete list of all available endpoints, visit the{" "}
                                                <a
                                                    href="https://aliengain.github.io/api-portal/pawa-api.html"
                                                    target="_blank"
                                                ...
                                                . This interactive Swagger documentation provides detailed information about all endpoints,
                                                request/response formats, and error codes.
                                            </p>
                                            <p>
                                                <strong>Pawa Proxy Guide:</strong> For detailed implementation examples and best practices,
                                                visit the{" "}
                                                <a href="/pawa-proxy-guide" className="underline hover:text-blue-900">
                                                    Pawa Proxy Guide
                                                </a>
                                                . This guide includes authentication flows, error handling strategies, and sample code.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <Card className="border-blue-200 bg-blue-50/50">
                                    ...
                                    <CardContent className="space-y-3">
                                        ...
                                        <Button variant="outline" size="lg" className="w-full" onClick={handleDownloadPrompt}>
                                            <div className="flex items-center gap-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="bg-green-100 border border-green-200 rounded-lg p-2">
                                                <p className="text-xs text-green-700">
                                                    💡 <strong>Tip:</strong> GIFs show user interactions and animations - perfect for
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-purple-700 mt-2 space-y-1">
                                            <p>
                                                <strong>v0:</strong> Drag and drop files (PNG, JPG, TXT) directly into the chat, or click the
                                                attachment button
                                            </p>
                                            <p>
                                                <strong>Replit:</strong> Upload files to your project folder, then reference with @filename
                                            </p>
                                            <p>
                                                <strong>ChatGPT/Claude:</strong> Use the paperclip icon to attach files (supports images, and
                                                text files)
                                            </p>
                                        </div>
                                    </div>
