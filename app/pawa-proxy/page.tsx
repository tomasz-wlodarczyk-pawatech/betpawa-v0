      ...
      <div className="flex-1 bg-background">
        <div className="container mx-auto p-6 space-y-8 max-w-4xl">
          ...
          <Alert className="bg-green-50 border-green-200">
            ...
            <AlertTitle className="text-green-800">Developer-friendly proxy</AlertTitle>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="bg-slate-800 text-white p-4 rounded-t-md font-mono text-sm overflow-x-auto relative group">
                  POST /api/user/v1/authenticate
                  <button
                    onClick={() => handleCopy("POST /api/user/v1/authenticate", "auth-endpoint")}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div className="bg-slate-50 p-4 rounded-md border border-slate-200">
                  ...
                  <p className="text-sm text-muted-foreground">Concentrate on frontend without backend distractions</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <Tabs defaultValue="request" className="w-full">
                  ...
                  <TabsContent value="request" className="space-y-4">
                    <div className="bg-slate-800 text-white p-4 rounded-md font-mono text-sm overflow-x-auto relative group">
                      {`curl -X GET "https://pawa-proxy.replit.app/api/preference/v1/component-data?x-pawa-brand=betpawa-ghana"`}
                      <button
                        onClick={() =>
                          handleCopy(
                            `curl -X GET "https://pawa-proxy.replit.app/api/preference/v1/component-data?x-pawa-brand=betpawa-ghana"`,
