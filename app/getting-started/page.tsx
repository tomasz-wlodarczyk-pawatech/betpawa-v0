                ...
                <div className="container mx-auto p-6 space-y-8 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xl text-muted-foreground">
                            Your comprehensive toolkit for building consistent, accessible, and beautiful user
                            interfaces.
                        </p>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <p className="text-muted-foreground leading-relaxed">
                                pawabloX is a modern design system that bridges the gap between design and development.
                                Built with
                                scalability and consistency in mind, it provides a unified language for teams to create
                                exceptional
                                digital experiences.
                            </p>

                            <p className="text-muted-foreground leading-relaxed">
                                Our system includes carefully crafted design tokens exported directly from Figma,
                                ensuring perfect
                                alignment between your designs and implementation. Whether you're building a simple
                                website or a complex
                                application, pawabloX provides the foundation you need to move fast without breaking
                                things.
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                                ...
                                <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">Built with modern frameworks and
                                            best practices</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Direct token export from Figma ensures your designs and code stay perfectly
                                        synchronized.
                                    </p>
                                </div>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    <div
                                        className="w-6 h-6 bg-green-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
                                        1
                                    </div>
                                    <div>
                                        <h4 className="font-semibold">Explore the Foundations</h4>
                                        <p className="text-sm text-muted-foreground">
                                            Start by browsing our design tokens, colors, typography, and spacing
                                            guidelines.
                                        </p>
                                    </div>
                                </div>
